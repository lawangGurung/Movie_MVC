...
namespace MVC_Movie.Controllers
{
    public class MoviesController : Controller
    {
        ...
        public async Task<IActionResult> Index(string searchString, string movieGenre)
        {
            ...
            {
                movies = movies.Where(movie => movie.Title!.ToUpper().Contains(searchString.ToUpper()));
            }

            IQueryable<string> movieGenres = from m in _context.Movie
                                            orderby m.Genre
                                            select m.Genre;
            ...
            {
                Genres = new SelectList(await movieGenres.Distinct().ToListAsync()),
